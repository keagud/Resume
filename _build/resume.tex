...
\begin{document}
    ...
    \sectioncontent{
      ...
      \project{\href{https://github.com/keagud/della}{Della}}{Python}
        ...
        \begin{itemize}
            \item A Discord bot with a modular design, allowing features and commands to be easily swapped out. 
            \item Current functionality includes: fortune telling with a simulated Tarot deck, generation of images based on a macro, user search of Wikipedia or Etymonline
        \end{itemize}
        \spacevv
        %%%%%%%%%%%%%%5
